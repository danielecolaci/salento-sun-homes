...
const translations: Record<Locale, Record<string, TranslationSection>> = {
  it: {
    ...
    hero: {
      ...
      subtitle: "4 accoglienti case vacanze nel cuore del Salento, perfette per famiglie, gruppi, ospiti con animali e soggiorni accessibili",
    ...
    features: {
      ...
      items: [
        ...
        { icon: "shield", title: "Conformi alle normative", desc: "Appartamenti a norma per accessibilità e sicurezza" },
    ...
    location: {
      ...
      description: "San Foca è una perla del Salento adriatico, con un mare cristallino e un lungomare vivace. La posizione strategica permette di raggiungere facilmente Otranto, Lecce e le più belle località del Salento. A pochi passi troverai ristoranti, bar, negozi e tutti i servizi per una vacanza perfetta.",
    },
    form: {
    ...
    testimonials: {
      ...
      items: [
        { name: "Famiglia Rossi", type: "family", text: "Vacanza perfetta! I bambini hanno adorato la spiaggia a due passi. Appartamento spazioso e pulitissimo." },
        { name: "Marco e Luna 🐾", type: "pet", text: "Finalmente un posto dove il nostro cane è davvero benvenuto. Spiaggia, passeggiate e relax per tutti." },
        { name: "Giovanni B.", type: "accessible", text: "Appartamento accessibile e curato nei dettagli. Abbiamo potuto goderci la vacanza senza preoccupazioni." },
        { name: "Sarah & James", type: "couple", text: "A wonderful holiday in Salento! Beautiful apartment, crystal clear sea and very kind hosts. We'll be back!" },
      ] as unknown as string,
    },
    finalCta: {
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: "4 welcoming vacation homes in the heart of Salento, perfect for families, groups, pet owners and accessible stays",
    ...
    location: {
      title: "San Foca, Salento",
      description: "San Foca is a gem of the Adriatic Salento, with crystal clear sea and a lively promenade. Its strategic location makes it easy to reach Otranto, Lecce and the most beautiful spots in Salento. Nearby you'll find restaurants, bars, shops and all the services for a perfect holiday.",
    },
    form: {
    ...
    testimonials: {
      ...
      items: [
        { name: "The Rossi Family", type: "family", text: "Perfect holiday! The kids loved the beach just steps away. Spacious and spotless apartment." },
        { name: "Marco & Luna 🐾", type: "pet", text: "Finally a place where our dog is truly welcome. Beach, walks and relaxation for everyone." },
        { name: "Giovanni B.", type: "accessible", text: "Accessible apartment with great attention to detail. We enjoyed our holiday worry-free." },
        { name: "Sarah & James", type: "couple", text: "A wonderful holiday in Salento! Beautiful apartment, crystal clear sea and very kind hosts. We'll be back!" },
      ] as unknown as string,
    },
    finalCta: {
